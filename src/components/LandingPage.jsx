...
//                         {index===1 && (<motion.div initial={{width:0}} animate={{width:"9vw"}} transition={{ease:[0.83, 0, 0.17, 1],duration:1}} className="w-[9vw] h-[5.3vw] bg-red-500 mr-2 mt-[1vw] rounded-lg">
//                             <img src={abc} alt="" className="w-full h-full object-cover rounded-md" />
//                         </motion.div>)}
